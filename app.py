...
def verify_login(username: str, password: str):
    ...
    try:
        ...
        if not user or not user.password_hash:
            return None  # None password_hash means this account was created via Google - no password to check
...
def get_or_create_google_user(email: str, google_id: str) -> int:
    """Finds an existing account by Google id or email, or creates a new one.
    ...
    try:
        ...
        new_user = User(username=username, email=email, google_id=google_id, password_hash=None)
