"""
Database layer: user accounts + Google accounts + analysis history.
...
# ============================================================
# Normal username/password users
# ============================================================
...
def verify_login(username: str, password: str):
    """
    Returns the user's id if the password is correct,
...
def get_or_create_google_user(email: str, google_id: str):
    """
    Find an existing Google account or create a new application user.
    ...
    try:
        ...
        google_account = (
            ...
            .filter(GoogleAccount.google_id == google_id)
            .first()
        )

        if google_account:
            return google_account.user_id

        # ----------------------------------------------------
        # 2. Create a username from the Google email
        # ----------------------------------------------------
        ...
        #
        # Google users don't need to know this password because
        # they authenticate through Google.
        # ----------------------------------------------------
        ...
        # Get user.id before creating GoogleAccount
        session.flush()

        # ----------------------------------------------------
        # 4. Connect Google account to our application user
        # ----------------------------------------------------
...
def save_analysis(
    ...
    """
    Saves an analysis and returns its new id.
    """
